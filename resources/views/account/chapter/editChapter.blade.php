        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{URL::to('/account/book/'.$truyen->id.'/chapter/'.$chapter->id.'/update')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <p for="name_slug">Tên Chương </p>
                                        <input type="text" disabled name="tenchuong"  value="{{$chapter->tenchuong}}" class="form-control form-control-border" id="name_slug">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="noidung" class="form-control form-control-border border-width-2" id="introduce">
                                            {{$chapter->noidung}}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
