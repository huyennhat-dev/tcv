                    ...
                    <div class="card ">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <?php $avata = "this.src='../public/dist/img/avatar2.png'"; ?>
                                                ...
                                                <td class="border ">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ml-3 ">
                                                            ...
                                                            <p class="mb-0">
                                                                <i class="text-secondary fa fa-copyright"></i> {{count($truyendangra_chapter[$key])}}
                                                ...
                                                <td class="border ">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ml-3 ">
                                                            ...
                                                            <p class="mb-0">
                                                                <i class="text-secondary fa fa-copyright"></i> {{count($truyenhoanthanh_chapter[$key])}}
                                                                <i class="text-secondary fa fa-eye m-l-10"></i> {{$val->luotxem}}
                                                                <i class="text-secondary fa fa-star m-l-10"></i> {{$val->sosao}}
                                                                <i class="text-secondary fa fa-comments m-l-10"></i> {{$val->sobinhluan}}
                                                            </p>
