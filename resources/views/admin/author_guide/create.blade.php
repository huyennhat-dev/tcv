            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Thêm hướng dẫn khách hàng</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Thêm hướng dẫn khách hàng</h3>
                        </div>
                        <!--  -->
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" action="{{route('author-guide.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="ques" class="font-weight-normal">Câu hỏi</label>
                                    <input autocomplete="off" class="form-control" id="ques" type="text" name="cauhoi" value="{{old('cauhoi')}}">
                                </div>
                                <style>
                                    #cke_1_top {
