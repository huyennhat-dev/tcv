            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Danh sách hướng dẫn tác giả</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Bảng danh sách hướng dẫn tác giả</h3>
                        </div>
                        <!-- /.card-header -->
                        <div id="yyyy">
                            <div class="card-body">
                                ...
                                <table class="table table-responsive table-hover" id="tbl_admin">
                                    <thead>
                                        ...
                                        <th class="w-30">STT</th>
                                            <th class="w-700">Hướng dẫn tác giả</th>
                                            <th class="w-250">Trạng thái</th>
                                            <th class="w-250">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($authorGuide as $key => $val)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form method="post" action="{{route('author-guide.destroy', [$val->id])}}">
                                                        @method('DELETE')
                                                        @csrf
                                                    ...
                                                    <a class="btn btn-primary btn-sm ml-2" href="{{route('author-guide.edit', [$val->id])}}">
