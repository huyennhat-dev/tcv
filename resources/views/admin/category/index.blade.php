                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Bảng danh sách thể loại</h3>
                        </div>
                        <!-- /.card-header -->
                        <div id="yyyy">
                                ...
                                <table class="table table-responsive table-hover" id="tbl_admin">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-200">Tên thể loại</th>
                                            <th class="w-700">Mô tả</th>
                                            <th class="w-200">Trạng thái</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a class="btn btn-primary btn-sm ml-2" href="{{route('category.edit', [$val->id])}}">
