            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('faqs.index')}}">Danh sách câu hỏi</a></li>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('faqs.update', [$faq->id])}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" class="form-control" id="ques" type="text" name="cauhoi" value="{{$faq->cauhoi}}">
                                </div>
                                <style>
                                    #cke_1_top {
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="cautraloi" name="cautraloi">{{$faq->cautraloi}}</textarea>
                                </div>
                                <div class="form-group">
