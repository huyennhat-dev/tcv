            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('sect.index')}}">Danh sách lưu phái</a></li>
                        <li class="breadcrumb-item active">Sửa lưu phái</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa lưu phái</h3>
                        </div>
                        <!--  -->
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" action="{{route('sect.update', [$sect->id])}}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <label for="name_slug" class="font-weight-normal">Tên tính cách nhân vật</label>
                                    <input readonly autocomplete="off" class="form-control" onkeyup="ChangeToSlug()" id="name_slug" type="text" name="tenluuphai" value="{{$sect->tenluuphai}}">
                                </div>
                                <input readonly autocomplete="off" class="form-control" id="convert_slug" type="hidden" name="slug" value="{{$sect->slug}}">
                                <div class="form-group">
