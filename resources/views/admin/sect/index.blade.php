            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Danh sách lưu phái</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Bảng danh sách lưu phái</h3>
                        </div>
                        <!-- /.card-header -->
                        <div id="yyyy">
                            <div class="card-body">
                                ...
                                <table class="table table-responsive table-hover" id="tbl_admin">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-700">Tên lưu phái</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form method="post" action="{{route('sect.destroy', [$val->id])}}">
                                                        @method('DELETE')
                                                        @csrf
                                                    ...
                                                    <a class="btn btn-primary btn-sm ml-2" href="{{route('sect.edit', [$val->id])}}">
