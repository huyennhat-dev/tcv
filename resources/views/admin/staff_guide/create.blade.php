            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Thêm nhân viên hướng dẫn</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Thêm nhân viên hướng dẫn</h3>
                        </div>
                        <!--  -->
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" action="{{route('staff-guide.store')}}" enctype="multipart/form-data">
                                @csrf
