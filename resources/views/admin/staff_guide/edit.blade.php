            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('staff-guide.index')}}">Danh sách nhân viên hướng dẫn</a></li>
                        <li class="breadcrumb-item active">Sửa nhân viên hướng dẫn</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa nhân viên hướng dẫn</h3>
                        </div>
                        <!--  -->
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" action="{{route('staff-guide.update', [$staffGuide->id])}}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <label for="ques" class="font-weight-normal">Câu hỏi</label>
                                    <input autocomplete="off" class="form-control" id="ques" type="text" name="cauhoi" value="{{$staffGuide->cauhoi}}">
                                </div>
                                <style>
                                    #cke_1_top {
