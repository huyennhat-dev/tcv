            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Danh sách nhân viên hướng dẫn</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Bảng danh sách nhân viên hướng dẫn</h3>
                        </div>
                        <!-- /.card-header -->
                        <div id="yyyy">
                            <div class="card-body">
                                ...
                                <table class="table table-responsive table-hover" id="tbl_admin">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-700">Nhân viên hướng dẫn</th>
                                            <th class="w-250">Trạng thái</th>
                                            <th class="w-250">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($staffGuide as $key => $val)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form method="post" action="{{route('staff-guide.destroy', [$val->id])}}">
                                                        @method('DELETE')
                                                        @csrf
                                                    ...
                                                    <a class="btn btn-primary btn-sm ml-2" href="{{route('staff-guide.edit', [$val->id])}}">
