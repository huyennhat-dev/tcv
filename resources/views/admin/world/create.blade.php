            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Thêm bối cảnh thế giới</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-11 col-md-11">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Thêm bối cảnh thế giới</h3>
                        </div>
                        <!--  -->
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" action="{{route('world.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name_slug" class="font-weight-normal">Tên bối cảnh thế giới</label>
                                    <input autocomplete="off" class="form-control" onkeyup="ChangeToSlug()" id="name_slug" type="text" name="tenthegioi" value="{{old('tenthegioi')}}">
                                </div>
