            ...
            <div class="col l-3 m-0 c-0 pt-12">
                <aside class="fz-13">
                    ...
                    <div class="py-2 border-bottom">
                        ...
                        <ul class="list-facet list-unstyled d-flex flex-wrap m-0">
                            <li><a href="" class="item rounded br-5"><small>Đang ra</small></a></li>
                            <li><a href="" class="item rounded br-5"><small>Hoàn thành</small></a></li>
                        </ul>
                    </div>
                    <div class="py-2 border-bottom">
                    ...
                    <div class="py-2 border-bottom">
                        ...
                        <ul class="list-facet list-unstyled d-flex flex-wrap m-0">
                            <li><a href="" class="item rounded br-5"><small>Truyện Nam</small></a></li>
                            <li><a href="" class="item rounded br-5"><small>Truyện Nữ</small></a></li>
                        </ul>
                    </div>
                </aside>
            </div>
                    ...
                    <div class="col l-6 m-6 c-12  border-bottom pb-25 pt-25 pl-15 pr-15">
                        <div class="media">
                            <a href="{{URL::to('/truyen/'.$val->slug)}}" class="nh-thumb nh-thumb--90 shadow mr-3">
                                <img src="{{asset('public/uploads/truyen/'.$val->hinhanh)}}" alt=" {{$val->tentruyen}}" width="90">
                            </a>
